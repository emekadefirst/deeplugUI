...
export default function Navbar() {
    ...
    const navLinks = [
        { href: '/about', label: 'About Us', icon: null, isExternal: false },
        { href: '/privacy', label: 'Privacy', icon: null, isExternal: false },
        { href: '#ai', label: 'deePlugg AI', icon: Sparkles, isExternal: false },
    ];
