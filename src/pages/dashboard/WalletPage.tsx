...
export const WalletPage = () => {
    const transactions = [
        { id: 1, type: 'credit', amount: 50.00, description: 'Wallet Top-up', date: '2026-01-15', status: 'completed' },
        { id: 2, type: 'debit', amount: 5.99, description: 'Account Verification', date: '2026-01-14', status: 'completed' },
    ];
